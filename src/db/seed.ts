...
async function main() {
  ...
  const email = process.env.SEED_ADMIN_EMAIL ?? "admin@hasarliakdeniz.com";
  ...
  await db
    ...
    .values([
      { key: "brand.name", value: "Hasarlı Akdeniz" },
      { key: "brand.tagline", value: "Akdeniz Bölgesi Hasarlı Araç Alım Merkezi" },
      ...
      { key: "contact.email", value: "info@hasarliakdeniz.com" },
