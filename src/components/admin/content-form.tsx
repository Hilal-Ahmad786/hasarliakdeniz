...
const field = "h-10 w-full rounded-md border border-line px-3 text-sm focus:border-brand-700 focus:outline-none";
  ...
  return (
    <form action={saveContent} className="space-y-4 rounded-[14px] border border-line bg-white p-6">
      ...
      <label className="block">
        ...
        <textarea name="excerpt" rows={2} defaultValue={item?.excerpt ?? ""} className="w-full rounded-md border border-line p-2.5 text-sm focus:border-brand-700 focus:outline-none" />
      </label>
      ...
      <label className="block">
        ...
        <textarea
          ...
          placeholder={"## Başlık\nParagraf metni...\n\n- Madde 1\n- Madde 2\n\n> Bilgi notu"}
          className="w-full rounded-md border border-line p-3 font-mono text-[13px] focus:border-brand-700 focus:outline-none"
        />
      ...
      <fieldset className="rounded-md border border-line p-4">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          <label className="block sm:col-span-2">
            ...
            <textarea name="seoDescription" rows={2} defaultValue={item?.seoDescription ?? ""} className="w-full rounded-md border border-line p-2.5 text-sm focus:border-brand-700 focus:outline-none" />
          </label>
          <label className="block">
      ...
      <button type="submit" className="rounded-md bg-brand-700 px-6 py-2.5 text-sm font-semibold text-white hover:bg-brand-800">
        {labels.save}
      </button>
    </form>
  );
