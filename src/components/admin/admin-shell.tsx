  ...
  const SidebarContent = (
    <div className="flex h-full flex-col">
      <div className="flex h-16 items-center gap-2.5 border-b border-white/10 px-5">
        <span className="grid h-8 w-8 place-items-center rounded-[8px] bg-brand-700 text-[13px] font-bold text-white">
          HA
        </span>
          ...
          return (
            <Link
              ...
              className={cn(
                ...
                active ? "bg-brand-700 text-white" : "text-white/70 hover:bg-white/8 hover:text-white",
              )}
            >
              <Icon size={18} />
              {item.label}
              ...
              {(["tr", "en"] as const).map((l) => (
                <button
                  ...
                  className={cn(
                    ...
                    locale === l ? "bg-brand-700 text-white" : "bg-white text-ink-muted hover:bg-cream-100",
                  )}
                >
                  {l}
                </button>
