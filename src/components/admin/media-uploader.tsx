    ...
    <div className="mb-5 rounded-[14px] border border-line bg-white p-4">
      <div className="flex flex-wrap items-end gap-2">
        <input
          ...
          className="h-10 w-40 rounded-md border border-line px-3 text-sm focus:border-brand-700 focus:outline-none"
        />
        <button
          type="button"
          onClick={() => inputRef.current?.click()}
          disabled={busy}
          className="inline-flex h-10 items-center gap-2 rounded-md bg-brand-700 px-5 text-sm font-semibold text-white hover:bg-brand-800 disabled:opacity-70"
        >
