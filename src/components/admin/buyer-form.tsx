...
const field =
  "h-10 w-full rounded-md border border-line px-3 text-sm focus:border-brand-700 focus:outline-none";
  ...
  return (
    <form action={saveBuyer} className="max-w-2xl space-y-4 rounded-[14px] border border-line bg-white p-6">
      ...
      <label className="block">
        ...
        <textarea name="notes" rows={3} defaultValue={buyer?.notes ?? ""} className="w-full rounded-md border border-line p-2.5 text-sm focus:border-brand-700 focus:outline-none" />
      </label>
