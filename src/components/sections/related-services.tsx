      ...
      <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {items.map((s) => (
          <Link
            ...
            className="group flex items-center gap-4 rounded-[14px] border border-line bg-cream-50 p-4 transition-colors hover:border-brand-700"
          >
            ...
            <div className="min-w-0">
              ...
              <span className="mt-1 inline-flex items-center gap-1 text-[13px] font-semibold text-brand-700">
                İncele
