      ...
      <div className="mt-10 grid grid-cols-2 gap-4 md:grid-cols-3 lg:grid-cols-4">
        {featuredServices.map((s) => (
          <Link
            ...
            className="group flex flex-col overflow-hidden rounded-[14px] border border-line bg-white transition-all hover:border-brand-700 hover:shadow-[0_12px_30px_rgba(22,27,31,0.08)]"
          >
