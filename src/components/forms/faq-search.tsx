      ...
      <div className="mx-auto max-w-xl">
        <div className="relative">
          ...
          <input
            ...
            className="h-12 w-full rounded-[10px] border border-line bg-white pl-11 pr-10 text-[15px] text-ink placeholder:text-ink-soft focus:border-brand-700 focus:outline-none focus-visible:shadow-[0_0_0_3px_rgba(122,36,50,0.18)]"
          />
          {query && (
            <button
              type="button"
