...
> ${settings.brandName}, Akdeniz Bölgesi genelinde hasarlı, kazalı, pert, arızalı, çalışmayan, yanmış, sel hasarlı, hurda ve çekme belgeli araçlar için değerlendirme ve satın alma süreci sunan bir araç alım hizmetidir. Araç sahibi fotoğraf ve araç bilgisiyle başvurur, değerlendirme sonrası teklif iletilir; anlaşma halinde noter devri ve ödeme süreci yürütülür.

## Hızlı Bilgiler
- Hizmet türü: Hasarlı / kazalı / pert / arızalı araç alımı (Akdeniz Bölgesi)
