...
export const metadata: Metadata = {
  ...
  description:
    "Akdeniz'de araç satışının yol haritası: değerleme mantığı, tramer sorgulama, noter devri ve değer kaybı tazminatı rehberleri.",
  keywords:
  ...
  return (
    <>
      ...
      <PageHero
        ...
        description="Satış kararından noter imzasına kadar her aşamayı adım adım anlatan uygulamalı rehberler."
      />
          ...
          {guides.map((g) => (
            ...
            >
              <div className="relative aspect-[16/10] bg-cream-100">
                ...
                <span className="absolute left-3 top-3 inline-flex items-center gap-1 rounded-full bg-white/90 px-2.5 py-1 text-[11px] font-semibold text-brand-700">
