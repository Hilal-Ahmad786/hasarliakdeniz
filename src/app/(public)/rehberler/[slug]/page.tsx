          ...
          <aside className="lg:col-span-3">
            <nav aria-label="Bölümler" className="lg:sticky lg:top-24">
              ...
              <ol className="space-y-1.5 border-l border-line">
                {g.chapters.map((c, i) => (
                  <li key={i}>
                    <a href={`#${anchor(i)}`} className="block border-l-2 border-transparent -ml-px py-1.5 pl-3 text-sm text-ink-secondary hover:border-brand-700 hover:text-brand-700">
                      {i + 1}. {c.title}
                    </a>
                  </li>
                ))}
