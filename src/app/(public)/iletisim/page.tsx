...
export const metadata: Metadata = {
  ...
  description:
    "Hasarlı, kazalı, pert ve hurda aracınız için bize ulaşın. Telefon veya WhatsApp ile 30 dakikada ücretsiz teklif. Akdeniz Bölgesi geneli hizmet.",
  keywords:
...
export default async function ContactPage() {
  ...
  const methods = [
    { icon: Phone, label: "Telefon", value: settings.phoneDisplay, href: telHref(settings), tone: "text-brand-700", track: "phone_click" },
    ...
    { icon: Mail, label: "E-posta", value: settings.email, href: `mailto:${settings.email}`, tone: "text-brand-700", track: undefined },
  ];
  return (
    <>
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {methods.map((m) => (
            <a
              ...
              className="flex items-center gap-4 rounded-[14px] border border-line bg-cream-50 p-5 transition-colors hover:border-brand-700"
            >
