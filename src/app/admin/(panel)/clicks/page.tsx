  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 lg:grid-cols-3">
        ...
        <div className="rounded-[14px] border-2 border-brand-700 bg-white p-5">
          <div className="flex items-center gap-2 text-brand-700">
            <Users size={15} />
            <span className="text-xs font-semibold uppercase tracking-wide">Toplam Benzersiz Kişi</span>
          </div>
          <div className="mt-2 text-[28px] font-bold leading-none text-brand-700">
      ...
      <div className="rounded-[14px] border-2 border-brand-700 bg-white p-5">
        <h2 className="text-sm font-bold text-brand-700">Kişi Bazında Tıklamalar</h2>
        <p className="mb-3 text-xs text-ink-muted">
