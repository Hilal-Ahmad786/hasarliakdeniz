          ...
          {call.recordingUrl && (
            <div className="mt-4 border-t border-line pt-4">
              {canRecording && call.recordingConsent ? (
                <a href={call.recordingUrl} target="_blank" rel="noopener noreferrer" className="text-sm font-semibold text-brand-700 hover:underline">
                  Kaydı dinle
                </a>
              ) : (
          ...
          {!call.qualified && can(user, "calls.read") && (
            <div className="rounded-[14px] border border-line bg-white p-5">
              ...
              <form action={qualifyCallManually}>
                ...
                <button type="submit" className="w-full rounded-md bg-brand-700 px-4 py-2 text-sm font-semibold text-white hover:bg-brand-800">
