            ...
            {canWrite && (
              <form action={addLeadNote} className="mb-4">
                ...
                <textarea name="body" rows={2} required placeholder="Not ekleyin…"
                  className="w-full rounded-md border border-line p-2.5 text-sm focus:border-brand-700 focus:outline-none" />
                <button type="submit" className="mt-2 rounded-md bg-brand-700 px-4 py-2 text-sm font-semibold text-white hover:bg-brand-800">
                  {t("leads.addNote")}
                </button>
              </form>
            )}
          ...
          {canAssign && (
            <Card title={t("leads.assignTo")}>
              <form action={assignLead} className="flex gap-2">
                ...
                <button type="submit" className="rounded-md bg-brand-700 px-4 text-sm font-semibold text-white hover:bg-brand-800">
                  {t("leads.assign")}
                </button>
              </form>
            </Card>
