      ...
      <div className="mb-6 flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2">
          {url && item.status === "published" && (
            <a href={url} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1 text-xs font-semibold text-brand-700 hover:underline">
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-[14px] border border-line bg-white p-5">
            ...
            <form action={addContentComment} className="mb-3">
              <input type="hidden" name="id" value={item.id} />
              <textarea name="comment" rows={2} required placeholder={t("content.comment")} className="w-full rounded-md border border-line p-2 text-sm focus:border-brand-700 focus:outline-none" />
