  ...
  return (
    <>
      <div className="mb-5 flex items-center justify-between">
        ...
        {canWrite && (
          <Link href="/admin/buyers/new" className="inline-flex items-center gap-1.5 rounded-md bg-brand-700 px-4 py-2 text-sm font-semibold text-white hover:bg-brand-800">
                ...
                <tr key={b.id} className="hover:bg-cream-50">
                  ...
                  <td className="px-4 py-3 text-right">
                    <div className="flex items-center justify-end gap-3">
                      ...
                      <Link href={`/admin/buyers/${b.id}`} className="text-xs font-semibold text-brand-700 hover:underline">
                        {t("common.view")}
                      </Link>
