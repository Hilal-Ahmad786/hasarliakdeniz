              ...
              <tr key={u.id} className="hover:bg-cream-50">
                ...
                <td className="px-4 py-3">
                  <form action={setUserRole} className="flex items-center gap-2">
                    ...
                    <button type="submit" className="text-xs font-semibold text-brand-700 hover:underline">{t("common.save")}</button>
                  </form>
                </td>
                <td className="px-4 py-3">
                ...
                <td className="px-4 py-3">
                  <div className="flex items-center justify-end gap-3">
                    <form action={toggleUser}>
                      ...
                      <button type="submit" className="text-xs font-medium text-ink-muted hover:text-brand-700">
