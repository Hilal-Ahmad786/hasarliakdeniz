            ...
            <div className="flex h-[70vh] flex-col">
              <div className="flex items-center justify-between border-b border-line px-4 py-3">
                ...
                {active.thread.leadId && (
                  <Link href={`/admin/leads/${active.thread.leadId}`} className="text-xs font-semibold text-brand-700 hover:underline">
                    {t("leads.detail")}
                  </Link>
                )}
              </div>
              ...
              <form action={sendWhatsAppReply} className="flex gap-2 border-t border-line p-3">
                ...
                <input name="body" required placeholder="Yanıt yazın…" className="h-10 flex-1 rounded-md border border-line px-3 text-sm focus:border-brand-700 focus:outline-none" />
