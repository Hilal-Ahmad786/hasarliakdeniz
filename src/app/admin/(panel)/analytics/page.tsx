  ...
  return (
    <div className="mt-5 space-y-6">
      ...
      <div className="rounded-[14px] border border-line bg-white p-5">
              ...
              return (
                <div key={s.day} className="group relative flex flex-1 flex-col items-center justify-end gap-1">
                  <div className="relative w-full max-w-[26px] overflow-hidden rounded-t bg-cream-200" style={{ height: Math.max(2, h) }}>
                    <div className="absolute bottom-0 w-full bg-brand-700" style={{ height: ch }} />
                  </div>
        ...
        <p className="mt-3 text-xs text-ink-muted"><span className="mr-1 inline-block h-2 w-2 rounded-sm bg-brand-700 align-middle" />Dönüşüm <span className="mx-1 inline-block h-2 w-2 rounded-sm bg-cream-200 align-middle" />Ziyaret</p>
      </div>
